...
class TagFormComponent
{
    ...
    #[LiveAction]
    public function generateTagSlug(SlugGeneratorInterface $slugGenerator, #[LiveArg] string $localeCode): void
    {
        $this->formValues['translations'][$localeCode]['slug'] = $slugGenerator->generate($this->formValues['translations'][$localeCode]['name']);
    }
}
